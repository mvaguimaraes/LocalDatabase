...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    private static final String KEY_ACTIVE = "factive";
    ...
    public void addContacts(Contact contact){
        ...
        values.put(KEY_ACTIVE, contact.getActive());
    ...
    public List<Contact> getActiveContacts() {
        ...
        //Contact active_contact = new Contact();
        // Select All Query
        String selectQuery = "SELECT  * FROM " + TABLE_CONTACTS + " WHERE factive = 'true' ORDER BY RANDOM() LIMIT 1";
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                contact.setActiveStatus(cursor.getString(2));
    ...
    public List<Contact> getOnlyUsers() {
        List<Contact> contactList = new ArrayList<Contact>();
        //Contact active_contact = new Contact();
        // Select All Query
        String selectQuery = "SELECT  * FROM " + TABLE_CONTACTS + " WHERE factive = 'true' AND ftype = 'Pessoa' ORDER BY RANDOM() LIMIT 1";
